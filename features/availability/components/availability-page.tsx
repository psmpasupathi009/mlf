...
export function AvailabilityPage({ user }: { user: PublicUser }) {
  ...
  return (
    <div className="space-y-6 pb-4">
      <PageHeader
        title="Availability"
        description="When the office can book you. Stay checked in on HRMS if you are in the office; use time away for court or travel, appointments for client meets, and leave only for full days off."
        actions={
